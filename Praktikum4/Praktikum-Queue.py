...
class queue:
    ...
    def enqueue(self,data):
        ...
        # jika queue kosong, front dan rear menunjuk ke node yg sama
        if self.is_empty():
            self.front = nodeBaru
            self.rear = nodeBaru
            return
        
        # jika queue tidak kosong, maka letakkan data ke setelah rear, dan jadikan data baru sebagai rear
    ...
    def dequeue(self):
        ...
        # jika setelah geser front jadi none, maka queue akan kosong
        # rear juga haru menjadi none
